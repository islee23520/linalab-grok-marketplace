...
import { ConfigurationError } from "../../plugins/cliproxy-api-provider/src/errors"
import { loadSettings } from "../../plugins/cliproxy-api-provider/src/schema"

const pluginRoot = path.resolve("plugins/cliproxy-api-provider")
